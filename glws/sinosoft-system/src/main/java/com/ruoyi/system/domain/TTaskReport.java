...
public class TTaskReport extends BaseEntity {
    ...
    private Double thcyglSize = 0.0;

    /** 退化草原改良建设投资 */
    @Excel(name = "退化草原改良建设投资")
    private Double thcyglMoney = 0.0;
    ...
    private Double ykcyzlSize = 0.0;;

    /** 已垦草原治理建设投资 */
    @Excel(name = "已垦草原治理建设投资")
    private Double ykcyzlMoney = 0.0;;
    /**
     * 围栏投资合计
     */
    @Excel(name = "围栏投资合计")
    ...
    /** 围栏合计亩数 */
    private Double wlmjCount = 0.0;

    /** 围栏合计投资金额 */
    private Double wljeCount = 0.0;
    ...
    public String toString() {
        return "TTaskReport{" +
                ...
                ", thcyglSize=" + thcyglSize +
                ", thcyglMoney=" + thcyglMoney +
                ", rgscdSize=" + rgscdSize +
                ...
                ", wlInvestment=" + wlInvestment +
                ", wlScale=" + wlScale +
                ", qtjeCount=" + qtjeCount +
                ", qtmjCount=" + qtmjCount +
                ", totalScale=" + totalScale +
                ", totalInvestment=" + totalInvestment +
                ", provinceScale=" + provinceScale +
                ", tmhcname='" + tmhcname + '\'' +
                ", hmhname='" + hmhname + '\'' +
                ", dz='" + dz + '\'' +
                ", dictLabel='" + dictLabel + '\'' +
    ...
    public Long getReportLevel() {
        return reportLevel;
    }

    public void setReportLevel(Long reportLevel) {
    ...
    public Integer getConcreteTime() {
        return concreteTime;
    }

    public void setConcreteTime(Integer concreteTime) {
