...
var gisMapName = "gis:glws-gisMap";
var gisTabName = "gis:glws-gisTab";
...
//点查通过经纬度 获取草类信息
function queryGressByPoint(lon,lat) {
    ...
    var url = source.getGetFeatureInfoUrl(
        [lon,lat], viewResolution, view.getProjection(),
