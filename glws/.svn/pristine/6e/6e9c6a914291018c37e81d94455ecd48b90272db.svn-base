package com.sinosoft.web.config;
...
public class WeatherJsonUtil {
	...
	public static List<Map<String, Object>> getWeekWeatherMap(String Cityid)
		...
		InputStreamReader isr = new InputStreamReader(connectionData.getInputStream(),"utf-8");
...
//			map.put("ptime", info.getString("ptime").toString());// 发布时间
	...
	public static void main(String[] args) throws IOException {
		Map<String, Object> todayWeather = getTodayWeather("101010100");
		System.out.println(todayWeather);
//		try {
//			//测试获取实时天气1(包含风况，湿度)
//			Map<String, Object> map = getTodayWeather1("101070201");
