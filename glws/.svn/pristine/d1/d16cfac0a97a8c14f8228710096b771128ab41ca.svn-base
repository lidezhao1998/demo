 ...
 */
@Controller
@RequestMapping("/system/analysisH")
public class TTaskAnalysisHController extends BaseController {
    ...
    public TableDataInfo list(TTaskReport tTaskReport) {
        ...
        startPage();
        List<TTaskReport> tTaskReports = tTaskReportMapper.selectAnalysisListH(tTaskReport);
        TTaskReport sumTTaskReport = new TTaskReport();
        for (int i = 0; i < tTaskReports.size(); i++) {
            ...
            //合计
            sumTTaskReport.setWlScale(sumTTaskReport.getWlScale() + newTTaskReport.getWlScale());
            sumTTaskReport.setJmSize(sumTTaskReport.getJmSize() + newTTaskReport.getJmSize());
            sumTTaskReport.setXmSize(sumTTaskReport.getXmSize() + newTTaskReport.getXmSize());
            sumTTaskReport.setHqlxSize(sumTTaskReport.getHqlxSize() + newTTaskReport.getHqlxSize());
            sumTTaskReport.setSmhzlSize(sumTTaskReport.getSmhzlSize() + newTTaskReport.getSmhzlSize());
            sumTTaskReport.setThcyglSize(sumTTaskReport.getThcyglSize() + newTTaskReport.getThcyglSize());
            sumTTaskReport.setRgscdSize(sumTTaskReport.getRgscdSize() + newTTaskReport.getRgscdSize());
            sumTTaskReport.setHspjSize(sumTTaskReport.getHspjSize() + newTTaskReport.getHspjSize());
            sumTTaskReport.setHttSize(sumTTaskReport.getHttSize() + newTTaskReport.getHttSize());
            sumTTaskReport.setDhcSize(sumTTaskReport.getDhcSize() + newTTaskReport.getDhcSize());
            sumTTaskReport.setZgmCount(sumTTaskReport.getZgmCount() + newTTaskReport.getZgmCount());
        }
        sumTTaskReport.setAddress("合计");
        tTaskReports.add(0, sumTTaskReport);
     ...
     * 任务统计-横向统计图表
     */
    @RequestMapping("/analysisHHistogram")
    @ResponseBody
    public List analysisHHistogram(TTaskReport tTaskReport) {
