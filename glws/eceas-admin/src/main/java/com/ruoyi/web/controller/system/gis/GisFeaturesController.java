...
public class GisFeaturesController extends BaseController {
    ...
    public String edit(@PathVariable("id") Long id, ModelMap mmap) {
        ...
        if (StringUtils.isNotNull(gisFeatures) && 100L == id) {
            gisFeatures.setParentName("无");
        }
    ...
    public List<Ztree> getListByType(@PathVariable("type") String type){

        List<Ztree> ztrees=gisFeatureService.getListByType(type);
